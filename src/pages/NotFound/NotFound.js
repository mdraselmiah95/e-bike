...
const NotFound = () => {
  return (
    <div className="text-center NotFound">
      ...
      <div className="text">
        <h1 className="text-danger bolder">404 Error</h1>
        <h2 className="text-danger bolder">Couldn't launch :(</h2>
        <h3 className="my-3 text-info">Page Not Found - lets take you</h3>
        <NavLink to="/home">
